...
$(function () {
  ...
  var form = $("#contact-form"),
    ...
    warningMessage = "So sorry. Server is currently down, Your mail cannot be sent at this time, please try reaching me by manually sending a mail to kamaldeenidreez@gmail.com .. Thanks a lot and best regards, always";
  ...
  form.on("submit", function (event) {
    ...
    if (!that.sended) {
      $.ajax({
        url: "https://formspree.io/kamaldeenidreez@gmail.com",
        type: "POST",
        data: form.serialize(),
